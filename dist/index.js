...
module.exports = AutoLaunch = (function() {
  ...
  function AutoLaunch(arg) {
    var isHidden, isMinimized, mac, name, path, versions;
    name = arg.name, isHidden = arg.isHidden, mac = arg.mac, path = arg.path, isMinimized = arg.isMinimized;
    ...
    this.opts = {
      ...
      isMinimizedOnLaunch: isMinimized != null ? isMinimized : false,
      mac: mac != null ? mac : {}
    };
